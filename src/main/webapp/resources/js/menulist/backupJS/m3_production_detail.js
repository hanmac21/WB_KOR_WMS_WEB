...
//						</div>
//						<div class="search-label">
//							<div class="productionDetail_searchVal_lineno">${i18n.t('search.lineno')}<!-- LINENO --></div>
//							<input type="text" id="productionDetail_searchVal_lineno" />
//						</div>
//						<div class="search-label">
//							<div class="productionDetail_searchVal_workcenter">${i18n.t('search.workCenter')}<!-- WORKCENTER --></div>
//							<input type="text" id="productionDetail_searchVal_workcenter" />
//						</div>
//						<div class="search-label">
//							<div class="productionDetail_searchVal_factory">OKYN</div>
//							<select id="productionDetail_searchVal_okyn" class="factory-select">
//								<option value="all">${i18n.t('search.all')}<!-- 전체 --></option>
...
//								<th class = "locationVal">${i18n.t('search.workCenter')}<!-- WORKPLACE --></th>
...
//
//	// ✅ 쿠키에서 공장 가져오기
//	const savedFactory = getCookie('selectedFactory'); // ex) 'SALTILLO' / 'PUEBLA'
//
//	// ✅ 공장 먼저 세팅
//	if (savedFactory && $(`#productionDetail_searchVal_factory option[value="${savedFactory}"]`).length) {
//		$("#productionDetail_searchVal_factory").val(savedFactory);
//	}
//
//	// ✅ 공장 값 기준으로 창고 옵션 재구성 (renderFactoryStorage의 change 로직 트리거)
//	$("#productionDetail_searchVal_factory").trigger("change");
//
//	// ✅ 날짜/텍스트 초기화
//	$("#productionDetail_searchVal_fromDate").val(fromDate);
//	$("#productionDetail_searchVal_toDate").val(toDate);
...
//
//	// ✅ 초기화 후 1페이지부터 재조회 (쿠키 공장/날짜로 조회 권장)
//	currentProductionDetailPage = 1;
//	performProductionDetailDBSearch({
//		fromDate,
//		toDate,
//		factory: savedFactory || $("#productionDetail_searchVal_factory").val()
//	});
//
//	console.log('검색 조건이 초기화되었습니다. (Factory from cookie:', savedFactory, ')');
//}
//
//
//
