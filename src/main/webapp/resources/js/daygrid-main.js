        ...
        SimpleDayGridEventRenderer.prototype.renderSegHtml = function (seg, mirrorInfo) {
            ...
            titleHtml =
                '<span class="fc-title">' +
                    ...
                    '</span>' +
                    '<div class="fc-extra-print">' +  // 추가된 div
			            '<span class="filecompareyn">' + (eventDef.extendedProps.filecompareyn || '') + '</span>' +
			            '<span class="deliverconfirmyn">' + (eventDef.extendedProps.deliverconfirmyn || '') + '</span>' +
			        '</div>' +
                    '<div class="fc-extra-info">' +  // 추가된 div
			            '<span class="dateadd">' + (eventDef.extendedProps.dateadd || '') + '</span>' +
			            '<span class="countno">' + (eventDef.extendedProps.countno || '') + '</span>' +
			        '</div>';
